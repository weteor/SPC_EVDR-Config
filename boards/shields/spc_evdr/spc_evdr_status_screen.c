...
/* #endif */
    ...
    lv_obj_t * spcevdr_icon;
    spcevdr_icon = lv_img_create(screen, NULL);
    lv_img_set_src(spcevdr_icon, &spcevdrlogo);
    lv_obj_align(spcevdr_icon, NULL, LV_ALIGN_IN_TOP_MID, 0,0);
